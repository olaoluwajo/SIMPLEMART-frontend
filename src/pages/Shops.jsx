...
function Shops() {
  ...
  return (
    <div className="bg-[#fefefa] dark:bg-[#040D12]">
      <Header />
      <section className='bg-[url("/images/banner/shop.png")] h-[220px] pt-6 bg-cover bg-no-repeat relative bg-left'>
      ...
      <section className="py-16">
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          ...
          <div className="w-full flex flex-wrap">
            ...
            >
              ...
              <div className="py-2">
                {categories.map((c, i) => (
                  ...
                  >
                    ...
                    <label
                      className="text-slate-600 block cursor-pointer dark:text-white"
                      htmlFor={c}
                    >
                      {c}
                    </label>
              ...
              <span className="text-slate-800 font-bold text-lg dark:text-white">
        ...
        <div className="w-9/12 md-lg:w-8/12 md:w-[85%] m-auto">
          <div className="pl-8 md:pl-0">
            <div className="py-4 bg-transparent mb-10 px-3 rounded-md flex justify-between items-start border ">
